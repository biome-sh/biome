#!/usr/bin/env bash
# Look up BlackDuck KB PURLs for each component in biome-core-deps.cyclonedx.json
...
#
#   Writes:  support/sbom/biome-core-deps.cyclonedx.json  (in-place update)
...
INPUT="support/sbom/biome-core-deps.cyclonedx.json"
DRY_RUN=false
