...
impl LauncherMessage for NetErr {
    ...
    fn from_proto(proto: generated::NetErr) -> Result<Self> {
        Ok(NetErr {
            code: generated::ErrCode::try_from(proto.code.ok_or(Error::ProtocolMismatch("code"))?)
...
impl From<PidOf> for generated::PidOf {
    fn from(value: PidOf) -> Self {
        generated::PidOf {
            service_name: Some(value.service_name),
        }
    }
}
...
impl From<PidIs> for generated::PidIs {
    ...
    fn from(value: PidIs) -> Self {
        generated::PidIs { pid: value.pid }
    }
}
...
impl LauncherMessage for VersionNumber {
    ...
    fn from_proto(proto: generated::VersionNumber) -> Result<Self> {
        Ok(VersionNumber {
            version: proto.version.ok_or(Error::ProtocolMismatch("version"))?,
        })
    }
}
...
impl LauncherMessage for Version {
    ...
    fn from_proto(_proto: generated::Version) -> Result<Self> {
        Ok(Version {})
    }
}
