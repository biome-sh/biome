...
use crate::{
    ...
    server::{Server, timing::Timing},
    swim::{Ack, Ping, PingReq, ProbePing, Swim},
};
...
fn pingreq(
    server: &Server, // TODO: eliminate this arg
    socket: &UdpSocket,
