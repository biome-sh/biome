...
[menu]
  [menu.biome]
    title = "Origin Membership & RBAC"
    identifier = "biome/origins/origin-rbac Builder RBAC"
...
- [Download the Biome CLI]({{< relref "install_biome.md" >}})
...
The `bio` CLI supports RBAC. You need to use the CLI to manage origin roles, you cannot manage origin roles from the Biome Builder site.
