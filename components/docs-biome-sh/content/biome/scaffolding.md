...
[menu]
  [menu.biome]
    title = "Scaffolding"
    identifier = "biome/plans/scaffolding"
    parent = "biome/plans"
    weight = 95
+++
...
* [core/scaffolding-ruby](https://github.com/biome-sh/core-plans/blob/main/scaffolding-ruby/doc/reference.md)
* [core/scaffolding-node](https://github.com/biome-sh/core-plans/tree/main/scaffolding-node)
* [core/scaffolding-gradle](https://github.com/biome-sh/core-plans/blob/main/scaffolding-gradle)
