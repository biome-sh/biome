Biome Builder acts as the core of Biome's Application Delivery Enterprise hub.
It provides a repository for all available Biome packages built by Biome and the supporting community, as well as search and an API for clients.
