...
[menu]
  [menu.biome]
    title = "Supervisor Design"
    identifier = "biome/supervisors/Supervisor Design"
...
Biome uses a gossip protocol named "Butterfly". This protocol provides failure detection, service discovery, and leader election to the Biome Supervisor.
