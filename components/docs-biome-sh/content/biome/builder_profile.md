...
[menu]
  [menu.biome]
    title = "Builder Profile"
    identifier = "biome/builder/builder-profile Builder Profile"
...
![Authorize the Biome Application](/images/biome/authorize.png)
...
![Access your Biome Builder profile](/images/biome/builder_profile.png)
...
![Copy your personal access token](/images/biome/copy-token.png)
...
![Navigate to Windows Environment Variables](/images/biome/environment_variable.png)
...
![Make new user variable](/images/biome/environment_variable_new.png)

Create a permanent environment variable by entering `BIO_AUTH_TOKEN` as the variable name. Next, paste the authorization token that you copied after you generated a new token on your profile page as the variable value. After you select the `OK`, you will see the new token in the user variables field.

![Save your BIO_AUTH_TOKEN](/images/biome/environment_variable_new_var.png)

To test that your new token works correctly, open the Command Prompt---which you can find by entering command in the Windows search box---and entering `echo %BIO_AUTH_TOKEN%`. You should see the value that you pasted into the environment variable.

#### Set the personal access token as a macOS Environment Variable

Set the `BIO_AUTH_TOKEN` in the CLI with:
