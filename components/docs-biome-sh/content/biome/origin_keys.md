...
[menu]
  [menu.biome]
    title = "Origin Keys"
    identifier = "biome/origins/origin-keys Origin Keys"
...
- [Get Biome]({{< relref "install_biome.md" >}})
...
- Use [`bio setup`]({{< relref "install_biome.md" >}}) to generate your first origin key pair as part of setting up the `bio` CLI
