...
[menu]
  [menu.biome]
    ...
    identifier = "biome/packages/promote Promoting Packages"
...
![Promoting packages through channels](/images/biome/biome-promote-packages-through-channels.png)
