...
[menu]
  [menu.biome]
    ...
    identifier = "biome/containers/ecs EC2 Container Service"
...
* [A Journey with Biome on Amazon ECS, Part 1](https://biome.sh/blog/a-journey-with-biome-on-amazon-ecs-part-1)
* [A Journey with Biome on Amazon ECS, Part 2](https://biome.sh/blog/a-journey-with-biome-on-amazon-ecs-part-2)
