...
[menu]
  [menu.biome]
    title = "Service Groups"
    identifier = "biome/services/Service Groups"
...
![Supervisor A running Redis](/images/biome/supervisor_a_before.png)

And here is Supervisor B's output:
![Supervisor B running Redis](/images/biome/supervisor_b_before.png)
...
![Supervisor A running Redis on a new port](/images/biome/supervisor_a_after.png)

and Supervisor B's output is:

![Supervisor B running Redis on a new port](/images/biome/supervisor_b_after.png)
