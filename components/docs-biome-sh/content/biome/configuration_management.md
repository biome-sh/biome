...
[menu]
  [menu.biome]
    title = "Configuration Management"
    identifier = "biome/reference/configuration-management"
    parent = "biome/reference"

+++
**Examples: [Ansible](https://www.ansible.com/), [Biome](https://biome.sh/products/biome-infra), [Puppet](https://puppet.com/), and [Salt](https://saltstack.com/)**
