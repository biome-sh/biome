...
[menu]
  [menu.biome]
    title = "Plan Contents"
    identifier = "biome/plans/plan-contents"
    parent = "biome/plans"
    weight = 30
+++

The following is a best practice guide to how to write a production quality plan. These best practices are reflected in the requirements for a user to contribute a plan to the Biome [Core Plans](https://github.com/biome-sh/core-plans/).
...
- Don't edit anything in `/bio/` directly.
- Don't write to anything in `/bio/` directly.
