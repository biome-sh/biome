...
studio_enter_command="$BIO_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-backline bash --login +h"
studio_build_environment=
studio_build_command="$BIO_ROOT_PATH/bin/build"
studio_run_environment=
studio_run_command="$BIO_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-backline bash --login"
...
finish_setup() {
  ...
  _bio pkg binlink --dest "$BIO_ROOT_PATH"/bin core/build-tools-bio bio
...
#!$bash_path/bin/sh
exec $BIO_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-plan-build bio-plan-build "\$@"
EOF
