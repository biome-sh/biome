...
studio_enter_command="$HAB_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-backline bash --login +h"
studio_build_environment=
studio_build_command="$HAB_ROOT_PATH/bin/build"
studio_run_environment=
studio_run_command="$HAB_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-backline bash --login"
...
#!$bash_path/bin/sh
exec $HAB_ROOT_PATH/bin/bio pkg exec core/build-tools-bio-plan-build bio-plan-build "\$@"
EOF
