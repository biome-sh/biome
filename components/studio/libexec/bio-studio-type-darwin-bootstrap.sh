...
studio_enter_command="$libexec_path/bio pkg exec core/build-tools-bio-backline bash --rcfile $HAB_STUDIO_ROOT/etc/profile"
studio_build_environment=
studio_build_command="${HAB_STUDIO_ROOT}${HAB_ROOT_PATH}/bin/build"
studio_run_environment=
studio_run_command="$libexec_path/bio pkg exec core/build-tools-bio-backline bash --rcfile $HAB_STUDIO_ROOT/etc/profile"
...
$libexec_path/bio pkg exec core/build-tools-bio-backline bio-plan-build "\$@"
EOF
