use super::{
    Identifiable, PackageIdent, PackageTarget,
    metadata::{MetaFile, PackageType},
};
use crate::{
    crypto::{Blake2bHash, artifact},
    error::{Error, Result},
...
impl PackageArchive {
    ...
    pub fn checksum(&self) -> Result<String> {
        Ok(Blake2bHash::from_file(&self.path)?.to_string())
    }

    pub fn cflags(&self) -> Option<&str> {
        self.read_metadata(MetaFile::CFlags)
    }

    pub fn config(&self) -> Option<&str> {
        self.read_metadata(MetaFile::Config)
    }
    ...
    pub fn ld_run_path(&self) -> Option<&str> {
        self.read_metadata(MetaFile::LdRunPath)
    }

    pub fn ldflags(&self) -> Option<&str> {
        self.read_metadata(MetaFile::LdFlags)
    }

    pub fn svc_user(&self) -> Option<&str> {
        self.read_metadata(MetaFile::SvcUser)
    }

    pub fn svc_group(&self) -> Option<&str> {
        self.read_metadata(MetaFile::SvcGroup)
    }
    ...
    pub fn path(&self) -> Option<&str> {
        self.read_metadata(MetaFile::Path)
    }
...
// Exposes the extended archive and header metadata. Types are stored as non biome primitives
...
impl TryFrom<PackageArchive> for PackageArchiveInfo {
    ...
    fn try_from(archive: PackageArchive) -> Result<Self> {
        ...
        Ok(PackageArchiveInfo {
            format_version: header.format().clone(),
...
mod tests {
    ...
    fn reading_artifact_extended_metadata() {
        ...
        assert_eq!(
            info.signature_raw,
            "AgdmAKa9wr4ExnSWe5rg2VJh6cc2vOfyXCs3JOnsSm1XtmtQNhhON6fhgp0hW0xZkNcgXmC1lQ7w5WdZU0M4Bjg4MDVlNTU3NWFiOGMwMjllNmQyNTgyNjEzNzlmYmQwMmQ0YmIzZDkwZTIwNjg0N2Q0NTUzYTFiZjczOTVkNjU="
        );
    ...
    fn serialize_packagearchiveinfo() {
        ...
        "build_tdeps": [],
        "exposes": [],
        "manifest": "happyhumans possums\n=========================\n\nMaintainer: The Biome Maintainers <humans@biome.sh>\nVersion: 8.1.4\nRelease: 20160427165340\nArchitecture: x86_64\nSystem: linux\nTarget: x86_64-linux\nLicense: apachev2 \nSource: [nosuchfile.tar.gz](nosuchfile.tar.gz)\nSHA: \nPath: /bio/pkgs/happyhumans/possums/8.1.4/20160427165340\nBuild Dependencies:  \nDependencies:  \nInterpreters:  \n\nPlan\n========\n\nBuild Flags\n-----------\n\nCFLAGS: \nLDFLAGS: \nLD_RUN_PATH: \n\n```bash\npkg_name=possums\npkg_origin=happyhumans\npkg_version=8.1.4\npkg_maintainer=\"The Biome Maintainers <humans@biome.sh>\"\npkg_license=('apachev2')\npkg_source=nosuchfile.tar.gz\npkg_deps=()\npkg_build_deps=()\n\ndo_build() {\n  cp -v $PLAN_CONTEXT/signme.dat signme.dat\n}\n\ndo_install() {\n  install -v -D signme.dat $pkg_prefix/share/signme.dat\n}\n\n# Turn the remaining default phases into no-ops\n\ndo_download() {\n  return 0\n}\n\ndo_verify() {\n  return 0\n}\n\ndo_unpack() {\n  return 0\n}\n\ndo_prepare() {\n  return 0\n}\n```\n\nFiles\n-----\n4cc8037f90192a8eecdb9b386a289d35be3c8cd7f92bd6b1d0e2d783dea592c6  /bio/pkgs/happyhumans/possums/8.1.4/20160427165340/IDENT\nd3b7abad38647ed804b5017c5b990acab7c85648b552a97043d4d86c70ce1f9d  /bio/pkgs/happyhumans/possums/8.1.4/20160427165340/TARGET\nb5bb9d8014a0f9b1d61e21e796d78dccdf1352f23cd32812f4850b878ae4944c  /bio/pkgs/happyhumans/possums/8.1.4/20160427165340/share/signme.dat",
        "config": null,
        "svc_user": null,
        "svc_group": null,
        "ld_run_path": null,
