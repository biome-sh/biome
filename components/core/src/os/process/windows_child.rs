...
use super::super::{super::crypto::dpapi::decrypt, users::get_current_username};
use crate::error::{Error, Result};
use biome_win_users::sid::{self, Sid};
...
use winapi::{
    ...
    um::{
        fileapi::{self, CREATE_ALWAYS, CREATE_NEW, OPEN_ALWAYS, OPEN_EXISTING, TRUNCATE_EXISTING},
...
fn create_user_environment(token: HANDLE, env: &mut HashMap<String, String>) -> io::Result<Vec<u16>> {
    unsafe {
        ...
        cvt(Environment::CreateEnvironmentBlock(
            &mut block,
