...
// should move into `biome_core::common` as `pub` with proper documentation.
...
// Hart file parser
#[derive(Clone)]
pub(crate) struct BioHartIdParser;

impl clap::builder::TypedValueParser for BioHartIdParser {
    type Value = String;
