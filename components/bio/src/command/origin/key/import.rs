...
use biome_core::{
    crypto::keys::{Key, KeyCache, PublicOriginSigningKey, SecretOriginSigningKey},
            ...
            match content.parse::<SecretOriginSigningKey>() {
                ...
                _ => {
                    ...
                    Err(CoreError::CryptoError(
                        "Could not parse content as an public or secret \
                                                origin signing key!"
                            .to_string(),
                    )
                    .into())
