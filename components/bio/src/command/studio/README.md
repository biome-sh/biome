...
```bash
export BIO_FEAT_NATIVE_PACKAGE_SUPPORT=1
...
The above configuration updates can be applied to the builder-api service using a user.toml file. Refer [this document](https://docs.biome.sh/service_updates/#using-a-_usertoml_-file) to know how.
