use crate::{common::ui::UI, error::Result};
use std::ffi::OsString;

const EXPORT_CMD_ENVVAR: &str = "BIO_PKG_EXPORT_CONTAINER_BINARY";
const EXPORT_PKG_IDENT_ENVVAR: &str = "BIO_PKG_EXPORT_CONTAINER_PKG_IDENT";
