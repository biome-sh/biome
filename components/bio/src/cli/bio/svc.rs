...
///
/// The service config files are in the format generated by `bio svc load --generate-config`.
...
pub struct SharedLoad {
    ...
    pub topology:              Option<biome_sup_protocol::types::Topology>,
    /// The update strategy
    ...
    #[serde(default)]
    pub strategy:              biome_sup_protocol::types::UpdateStrategy,
    ...
    #[serde(default)]
    pub binding_mode:          biome_sup_protocol::types::BindingMode,
...
pub fn shared_load_cli_to_ctl(ident: PackageIdent,
                              ...
                              force: bool)
                              -> Result<biome_sup_protocol::ctl::SvcLoad> {
    use biome_common::{ui,
                         ui::UIWriter};
    #[cfg(target_os = "windows")]
...
impl TryFrom<Load> for biome_sup_protocol::ctl::SvcLoad {
...
pub struct Update {
    ...
    #[structopt(long = "strategy",
                short = "s",
                possible_values = &["none", "at-once", "rolling"])]
    pub strategy: Option<biome_sup_protocol::types::UpdateStrategy>,
