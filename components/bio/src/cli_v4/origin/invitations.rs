// Implementation of `bio origin invitations`
...
impl OriginInvitationsCommand {
    pub(super) async fn execute(&self, ui: &mut UI) -> BioResult<()> {
        ...
        match self {
            OriginInvitationsCommand::Accept {
                origin,
                invitation_id,
                bldr_url,
                auth_token,
            ...
            OriginInvitationsCommand::Ignore {
                origin,
                invitation_id,
                bldr_url,
                auth_token,
            ...
            OriginInvitationsCommand::Pending {
                origin,
                bldr_url,
                auth_token,
            } => {
            ...
            OriginInvitationsCommand::Rescind {
                origin,
                invitation_id,
                bldr_url,
                auth_token,
