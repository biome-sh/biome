// Implementation of `bio pkg uninstall` command
use clap_v4 as clap;

use clap::{ArgAction, Parser};

use biome_core::{fs::FS_ROOT_PATH, package::PackageIdent};

use biome_common::{cli::clap_validators::BioPkgIdentValueParser, ui::UI};

use crate::{
    command::pkg::{ExecutionStrategy, Scope, uninstall, uninstall::UninstallHookMode},
...
impl PkgUninstallOptions {
    pub(crate) async fn do_uninstall(&self, ui: &mut UI) -> BioResult<()> {
