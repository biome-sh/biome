// Implementation of `bio pkg bulkupload`
...
use biome_common::{cli::clap_validators::DirExistsValueParser, ui::UI};
...
impl PkgBulkUploadOptions {
    pub(super) async fn do_bulkupload(&self, ui: &mut UI) -> BioResult<()> {
