// Implementation of `bio pkg binlink`
...
use biome_common::{
    cli::{BINLINK_DIR_ENVVAR, DEFAULT_BINLINK_DIR, clap_validators::BioPkgIdentValueParser},
    ui::UI,
};

use crate::{command::pkg::binlink, error::Result as BioResult};
