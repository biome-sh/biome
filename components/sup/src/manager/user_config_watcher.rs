use crate::manager::{
    file_watcher::{Callbacks, FileWatcher},
    service::Service,
};
use biome_common::{liveliness_checker, outputln, templating::config::UserConfigPath};
use biome_core::{fs::USER_CONFIG_FILE, service::ServiceGroup};
use log::debug;
use std::{
    collections::HashMap,
    io,
