...
biome_core::env_config_duration!(ThreadAliveThreshold, HAB_THREAD_ALIVE_THRESHOLD_SECS => from_secs, Duration::from_secs(5 * 60));
biome_core::env_config_duration!(ThreadAliveCheckDelay, HAB_THREAD_ALIVE_CHECK_DELAY_SECS => from_secs, Duration::from_secs(60));
biome_core::env_config_duration!(ThreadDeadIgnoreDelay, HAB_THREAD_DEAD_IGNORE_DELAY_SECS => from_secs, Duration::from_secs(60 * 60 * 24 * 7)); // 1 week
