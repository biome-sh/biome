...
Describe "Supervisor package cleanup" {
    It "loads old Supervisor versions" {
        bio pkg install "biome/bio-sup/2.0.171" --channel unstable
        bio pkg install "biome/bio-sup/2.0.172" --channel unstable
        bio pkg install "biome/bio-sup/2.0.173" --channel unstable
        bio pkg install "biome/bio-sup/2.0.174" --channel unstable
