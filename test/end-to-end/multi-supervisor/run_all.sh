...
# extends keyword.
sudo -E bio pkg install core/docker-compose/1.29.2/20220312064236
sudo rm -f /bin/docker-compose
sudo -E bio pkg binlink core/docker-compose docker-compose --force
...
make biome_integration_base CHANNEL="${channel}"
