Describe 'bio plan render' {

    BeforeAll {
        $tempdir = New-TemporaryDirectory

        $output = bio plan render ./test/fixtures/render/consul/config/consul_config.json `
...
Describe 'bio plan init' {
    ...
    It 'normal plan file (scaffolding placeholder)' {
        bio plan init --origin foo bar 2>&1 | Out-Null
        $LASTEXITCODE | Should -Be 0
        $plan_path | Should -Exist
        $plan_path | Should -FileContentMatch "# This file is the heart of your application's biome."
    ...
    It 'minimal plan file (scaffolding placeholder)' {
        bio plan init --origin foo --min bar 2>&1 | Out-Null
        $LASTEXITCODE | Should -Be 0
        $plan_path | Should -Exist
        $plan_path | Should -Not -FileContentMatch "# This file is the heart of your application's biome."
        $plan_path | Should -FileContentMatch 'pkg_scaffolding="some/scaffolding"'
        $plan_path | Should -Not -FileContentMatch 'pkg_scaffolding="core/scaffolding-.+"'
    }

    It 'minimal plan file with scaffolding specified' {
        bio plan init --origin foo --min bar --scaffolding go 2>&1 | Out-Null
        $LASTEXITCODE | Should -Be 0
        $plan_path | Should -Exist
        $plan_path | Should -Not -FileContentMatch "# This file is the heart of your application's biome."
